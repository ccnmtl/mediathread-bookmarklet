    ...
    *************/
    ...
    "Interface" : function (host_url, options) {
        ...
        this.loadStyles = function(){
            ...
            jQ('head').append('<link rel="stylesheet" type="text/css" href="'+ root_url +'/media/js/mediathread-bookmarklet/bookmarklet_styles.css">');
            ...
            if (asset.disabled) {
                ...
                jQ(form.submitButton2).click(function(){
                    ...
                    jQ('#submit-input',bucket_window.document).click(function(){
                        ...
                        var alertSaved = jQ('<div class="alert-saved"><span style="font-weight:bold">Success.</span> Your item has been successfully added to your <a href="'+ collectionUrl +'">Mediathread collection</a>.</div>');
